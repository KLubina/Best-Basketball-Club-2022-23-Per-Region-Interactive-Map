// Basketball Club Data with Correct Coordinates
const CLUBS_DATA = [
    ...
    { rank: 7, name: "Los Angeles Clippers", lat: 34.0522, lng: -118.2437, country: "USA" },
    ...
    { rank: 26, name: "Toronto Raptors", lat: 43.6532, lng: -79.3832, country: "Canada" },
    ...
    { rank: 29, name: "Fenerbahçe Beko", lat: 41.0082, lng: 28.9784, country: "Turkey" }, // Istanbul
    ...
    { rank: 34, name: "Panathinaikos BC", lat: 37.9755, lng: 23.7348, country: "Greece" }, // Athens
    ...
    { rank: 52, name: "Galatasaray Nef", lat: 41.0082, lng: 28.9784, country: "Turkey" }, // Istanbul
    ...
    { rank: 56, name: "KK Partizan MozzartBet", lat: 44.7866, lng: 20.4489, country: "Serbia" }, // Belgrade
    ...
    { rank: 60, name: "Besiktas", lat: 41.0082, lng: 28.9784, country: "Turkey" }, // Istanbul
    ...
    { rank: 65, name: "Fortitudo Bologna", lat: 44.4949, lng: 11.3426, country: "Italy" }, // Bologna
    { rank: 66, name: "Paris Basketball", lat: 48.8566, lng: 2.3522, country: "France" }, // Paris
    { rank: 67, name: "UCLA Bruins", lat: 34.0522, lng: -118.2437, country: "USA" }, // Los Angeles
    { rank: 68, name: "SIG Strasbourg", lat: 48.5734, lng: 7.7521, country: "France" }, // Strasbourg
    { rank: 69, name: "Bahçesehir Koleji", lat: 41.0082, lng: 28.9784, country: "Turkey" }, // Istanbul
    ...
    { rank: 75, name: "Tofas", lat: 40.1826, lng: 29.0665, country: "Turkey" }, // Bursa
    { rank: 76, name: "Unahotels Reggio Emilia", lat: 44.6989, lng: 10.6346, country: "Italy" }, // Reggio Emilia
    { rank: 77, name: "AEK BC", lat: 37.9755, lng: 23.7348, country: "Greece" }, // Athens
    ...
    { rank: 85, name: "Hapoel Tel Aviv", lat: 32.0853, lng: 34.7818, country: "Israel" }, // Tel Aviv
    ...
    { rank: 89, name: "Darüssafaka", lat: 41.0082, lng: 28.9784, country: "Turkey" }, // Istanbul
    ...
    { rank: 97, name: "BC Wolves", lat: 54.6872, lng: 25.2797, country: "Lithuania" }, // Vilnius
    ...
    { rank: 102, name: "Peristeri BC", lat: 37.9755, lng: 23.7348, country: "Greece" }, // Athens area
    ...
    { rank: 140, name: "USC Trojans", lat: 34.0522, lng: -118.2437, country: "USA" }, // Los Angeles
    ...
    { rank: 147, name: "Miami Hurricanes", lat: 25.7617, lng: -80.1918, country: "USA" }, // Miami
    ...
    { rank: 156, name: "PAOK BC", lat: 40.6403, lng: 22.9439, country: "Greece" }, // Thessaloniki
    ...
    { rank: 160, name: "Maccabi Effie Capital Rishon LeZion", lat: 31.9730, lng: 34.7925, country: "Israel" }, // Rishon LeZion
    ...
    { rank: 165, name: "Nanterre 92", lat: 48.8566, lng: 2.3522, country: "France" }, // Paris area
    ...
    { rank: 176, name: "Minnesota Golden Gophers", lat: 44.9778, lng: -93.2650, country: "USA" }, // Minneapolis
    { rank: 177, name: "Syntainics MBC", lat: 51.4969, lng: 11.9695, country: "Germany" }, // Weissenfels
    { rank: 178, name: "Onvo Büyükçekmece Basketbol", lat: 41.0082, lng: 28.9784, country: "Turkey" }, // Istanbul
    ...
    { rank: 185, name: "BC Neptunas Klaipeda", lat: 55.7172, lng: 21.1175, country: "Lithuania" }, // Klaipeda
    ...
    { rank: 190, name: "Hapoel Nofar Galil Elyon", lat: 32.9375, lng: 35.5364, country: "Israel" }, // Galilee
    ...
    { rank: 193, name: "Houston Cougars", lat: 29.7604, lng: -95.3698, country: "USA" }, // Houston
    ...
    { rank: 199, name: "Melbourne United", lat: -37.8136, lng: 144.9631, country: "Australia" }, // Melbourne
    ...
    { rank: 226, name: "KK Mega MIS", lat: 44.7866, lng: 20.4489, country: "Serbia" }, // Belgrade
    ...
    { rank: 251, name: "Memphis Tigers", lat: 35.1495, lng: -90.0490, country: "USA" }, // Memphis
    ...
    { rank: 266, name: "Utah Utes", lat: 40.7608, lng: -111.8910, country: "USA" }, // Salt Lake City
    { rank: 267, name: "Élan Chalon", lat: 46.7833, lng: 4.8333, country: "France" }, // Chalon-sur-Saône
    { rank: 268, name: "Tulane Green Wave", lat: 29.9511, lng: -90.0715, country: "USA" }, // New Orleans
    ...
    { rank: 271, name: "Apollon Patras", lat: 38.2466, lng: 21.7346, country: "Greece" }, // Patras
    ...
    { rank: 280, name: "San Diego Toreros", lat: 32.7157, lng: -117.1611, country: "USA" }, // San Diego
    ...
    { rank: 284, name: "DePaul Blue Demons", lat: 41.8781, lng: -87.6298, country: "USA" }, // Chicago
    ...
    { rank: 293, name: "KK FMP Meridian", lat: 44.7866, lng: 20.4489, country: "Serbia" }, // Belgrade
    { rank: 294, name: "Washington State Cougars", lat: 46.7298, lng: -117.1817, country: "USA" }, // Pullman
    { rank: 295, name: "Portland Pilots", lat: 45.5152, lng: -122.6784, country: "USA" }, // Portland
    { rank: 296, name: "RSW Liège Basket", lat: 50.6326, lng: 5.5797, country: "Belgium" }, // Liège
    { rank: 297, name: "Alliance Sport Alsace", lat: 48.5734, lng: 7.7521, country: "France" }, // Strasbourg
    { rank: 298, name: "CS San Martín Corrientes", lat: -27.4692, lng: -58.8306, country: "Argentina" }, // Corrientes
    { rank: 299, name: "Movistar Estudiantes", lat: 40.4168, lng: -3.7038, country: "Spain" }, // Madrid
    { rank: 300, name: "Georgetown Hoyas", lat: 38.9072, lng: -77.0369, country: "USA" }, // Washington DC
    ...
    { rank: 305, name: "Marquette Golden Eagles", lat: 43.0389, lng: -87.9065, country: "USA" }, // Milwaukee
    ...
    { rank: 308, name: "Butler Bulldogs", lat: 39.7684, lng: -86.1581, country: "USA" }, // Indianapolis
    ...
    { rank: 316, name: "Yoast United", lat: 52.1601, lng: 4.4970, country: "Netherlands" }, // Leiden
    ...
    { rank: 324, name: "Richmond Spiders", lat: 37.5407, lng: -77.4360, country: "USA" }, // Richmond
    ...
    { rank: 333, name: "Iraklis Thessaloniki", lat: 40.6403, lng: 22.9439, country: "Greece" }, // Thessaloniki
    ...
    { rank: 338, name: "UCF Knights", lat: 28.5383, lng: -81.3792, country: "USA" }, // Orlando
    ...
    { rank: 348, name: "Panerythraikos BC", lat: 37.9473, lng: 23.6647, country: "Greece" }, // Athens
    ...
    { rank: 357, name: "Saint Joseph's Hawks", lat: 39.9526, lng: -75.1652, country: "USA" }, // Philadelphia
    { rank: 358, name: "Boulazac Basket Dordogne", lat: 45.1833, lng: 0.7167, country: "France" }, // Boulazac
    { rank: 359, name: "Duquesne Dukes", lat: 40.4406, lng: -79.9959, country: "USA" }, // Pittsburgh
    { rank: 360, name: "Leyma Coruña", lat: 43.3623, lng: -8.4115, country: "Spain" }, // A Coruña
    { rank: 361, name: "Toledo Rockets", lat: 41.6528, lng: -83.5379, country: "USA" }, // Toledo
    { rank: 362, name: "George Washington Colonials", lat: 38.9072, lng: -77.0369, country: "USA" }, // Washington DC
    ...
    { rank: 369, name: "Basketball Academie Limburg", lat: 50.8798, lng: 5.6926, country: "Belgium" }, // Hasselt
    ...
    { rank: 375, name: "Club Regatas Corrientes", lat: -27.4692, lng: -58.8306, country: "Argentina" }, // Corrientes
    ...
    { rank: 381, name: "Loyola Marymount Lions", lat: 34.0522, lng: -118.4183, country: "USA" }, // Los Angeles
    { rank: 382, name: "Grupo Alega Cantabria CBT", lat: 43.4623, lng: -3.8100, country: "Spain" }, // Santander
    { rank: 383, name: "Detroit Mercy Titans", lat: 42.3314, lng: -83.0458, country: "USA" }, // Detroit
    ...
    { rank: 389, name: "Boston University Terriers", lat: 42.3601, lng: -71.0589, country: "USA" }, // Boston
    ...
    { rank: 392, name: "La Salle Explorers", lat: 39.9526, lng: -75.1652, country: "USA" }, // Philadelphia
    ...
    { rank: 398, name: "Rhode Island Rams", lat: 41.8240, lng: -71.4128, country: "USA" }, // Kingston
    ...
    { rank: 402, name: "AO Tritonas", lat: 37.9473, lng: 23.6647, country: "Greece" }, // Athens
    { rank: 403, name: "Northern Kentucky Norse", lat: 39.0458, lng: -84.5120, country: "USA" }, // Highland Heights
    { rank: 404, name: "CA Peñarol", lat: -34.8844, lng: -56.0181, country: "Uruguay" }, // Montevideo
    ...
    { rank: 413, name: "Hofstra Pride", lat: 40.7282, lng: -73.5985, country: "USA" }, // Hempstead
    { rank: 414, name: "Oberá Tenis Club", lat: -27.4864, lng: -55.1192, country: "Argentina" }, // Oberá
    { rank: 415, name: "Belmont Bruins", lat: 36.1447, lng: -86.8027, country: "USA" }, // Nashville
    { rank: 416, name: "Wright State Raiders", lat: 39.7589, lng: -84.1916, country: "USA" }, // Dayton
    ...
    { rank: 426, name: "Seattle U Redhawks", lat: 47.6062, lng: -122.3321, country: "USA" }, // Seattle
    { rank: 427, name: "Lille Métropole Basket", lat: 50.6292, lng: 3.0573, country: "France" }, // Lille
    { rank: 428, name: "Club Comunicaciones", lat: -34.6037, lng: -58.3816, country: "Argentina" }, // Buenos Aires
    ...
    { rank: 437, name: "Brown Bears", lat: 41.8240, lng: -71.4128, country: "USA" }, // Providence
    ...
    { rank: 440, name: "Loyola Chicago Ramblers", lat: 41.8781, lng: -87.6298, country: "USA" },
    ...
    { rank: 444, name: "NEA Filadelfeia", lat: 37.9473, lng: 23.6647, country: "Greece" }, // Athens
    { rank: 445, name: "CSU Bakersfield Roadrunners", lat: 35.3733, lng: -119.0187, country: "USA" }, // Bakersfield
    { rank: 446, name: "Tennessee State Tigers", lat: 36.1627, lng: -86.7816, country: "USA" }, // Nashville
    { rank: 447, name: "UIC Flames", lat: 41.8781, lng: -87.6298, country: "USA" }, // Chicago
    { rank: 448, name: "BC Zalgiris Kaunas 2", lat: 54.8985, lng: 23.9036, country: "Lithuania" }, // Kaunas
    ...
    { rank: 459, name: "Oral Roberts Golden Eagles", lat: 36.1540, lng: -95.9928, country: "USA" }, // Tulsa
    ...
    { rank: 464, name: "Obras Basket", lat: -34.6037, lng: -58.3816, country: "Argentina" }, // Buenos Aires
    ...
    { rank: 472, name: "UTSA Roadrunners", lat: 29.4241, lng: -98.4936, country: "USA" }, // San Antonio
    { rank: 473, name: "Milwaukee Panthers", lat: 43.0389, lng: -87.9065, country: "USA" },
    ...
    { rank: 478, name: "Club Ciclista Olímpico", lat: -27.4692, lng: -58.8306, country: "Argentina" }, // Corrientes
    ...
    { rank: 486, name: "Northeastern Huskies", lat: 42.3601, lng: -71.0589, country: "USA" }, // Boston
    ...
    { rank: 490, name: "Denver Pioneers", lat: 39.7392, lng: -104.9903, country: "USA" }, // Denver
    { rank: 491, name: "KK Pelister-Bitola", lat: 41.0361, lng: 21.3344, country: "North Macedonia" }, // Bitola
    { rank: 492, name: "Charlotte 49ers", lat: 35.2271, lng: -80.8431, country: "USA" }, // Charlotte
    ...
    { rank: 502, name: "Florida International Panthers", lat: 25.7617, lng: -80.1918, country: "USA" }, // Miami
    { rank: 503, name: "Rice Owls", lat: 29.7604, lng: -95.3698, country: "USA" }, // Houston
    ...
    { rank: 507, name: "KK Borac WWIN", lat: 44.1953, lng: 17.9051, country: "Bosnia and Herzegovina" }, // Banja Luka
    ...
    { rank: 510, name: "Cleveland State Vikings", lat: 41.4993, lng: -81.6944, country: "USA" }, // Cleveland
    ...
    { rank: 514, name: "Club Biguá", lat: -34.8844, lng: -56.0181, country: "Uruguay" }, // Montevideo
    ...
    { rank: 518, name: "American University Eagles", lat: 38.9072, lng: -77.0369, country: "USA" }, // Washington DC
    ...
    { rank: 530, name: "St. Thomas - Minnesota Tommies", lat: 44.9778, lng: -93.2650, country: "USA" }, // St. Paul
    { rank: 531, name: "KK Podgorica", lat: 42.4304, lng: 19.2594, country: "Montenegro" }, // Podgorica
    { rank: 532, name: "Monmouth Hawks", lat: 40.2677, lng: -74.0059, country: "USA" }, // West Long Branch
    { rank: 533, name: "Bellarmine Knights", lat: 38.2527, lng: -85.7585, country: "USA" }, // Louisville
    ...
    { rank: 541, name: "Merrimack Warriors", lat: 42.6334, lng: -71.3162, country: "USA" }, // North Andover
    ...
    { rank: 544, name: "IUPUI Jaguars", lat: 39.7684, lng: -86.1581, country: "USA" }, // Indianapolis
    ...
    { rank: 547, name: "KK Atletas", lat: 54.6872, lng: 25.2797, country: "Lithuania" }, // Vilnius
    { rank: 548, name: "Drexel Dragons", lat: 39.9526, lng: -75.1652, country: "USA" }, // Philadelphia
    ...
    { rank: 556, name: "Jacksonville Dolphins", lat: 30.3322, lng: -81.6557, country: "USA" }, // Jacksonville
    ...
    { rank: 559, name: "Canisius Golden Griffins", lat: 42.8864, lng: -78.8784, country: "USA" }, // Buffalo
    ...
    { rank: 567, name: "AO Amyntas", lat: 40.6167, lng: 22.0167, country: "Greece" }, // Amyntaio
    ...
    { rank: 571, name: "Kavala BC", lat: 41.0556, lng: 24.4056, country: "Greece" }, // Kavala
    ...
    { rank: 574, name: "Sacramento State Hornets", lat: 38.5816, lng: -121.4944, country: "USA" }, // Sacramento
    { rank: 575, name: "Saint Peter's Peacocks", lat: 40.7282, lng: -74.0776, country: "USA" }, // Jersey City
    { rank: 576, name: "Rider Broncs", lat: 40.2677, lng: -74.7429, country: "USA" }, // Lawrenceville
    { rank: 577, name: "Vilniaus Stekas", lat: 54.6872, lng: 25.2797, country: "Lithuania" }, // Vilnius
    ...
    { rank: 582, name: "Vilniaus Perlas", lat: 54.6872, lng: 25.2797, country: "Lithuania" }, // Vilnius
    ...
    { rank: 588, name: "Chicago State Cougars", lat: 41.8781, lng: -87.6298, country: "USA" },
    { rank: 589, name: "Portland State Vikings", lat: 45.5152, lng: -122.6784, country: "USA" }, // Portland
    ...
    { rank: 592, name: "CA Unión", lat: -31.4201, lng: -64.1888, country: "Argentina" }, // Córdoba
    ...
    { rank: 599, name: "Pennsylvania Quakers", lat: 39.9526, lng: -75.1652, country: "USA" }, // Philadelphia
    ...
    { rank: 603, name: "CD Las Ánimas", lat: -33.4489, lng: -70.6693, country: "Chile" }, // Santiago
    { rank: 604, name: "Römerstrom Gladiators Trier", lat: 49.7596, lng: 6.6441, country: "Germany" }, // Trier
    { rank: 605, name: "KK TFT Skopje", lat: 41.9973, lng: 21.4280, country: "North Macedonia" }, // Skopje
    ...
    { rank: 608, name: "Independiente Oliva", lat: -34.8844, lng: -56.0181, country: "Uruguay" }, // Montevideo
    ...
    { rank: 619, name: "CD Universidad Católica", lat: -33.4489, lng: -70.6693, country: "Chile" }, // Santiago
    { rank: 620, name: "Juaristi ISB", lat: 43.2630, lng: -2.9350, country: "Spain" }, // San Sebastián
    ...
    { rank: 635, name: "Klaipedos Neptunas-Akvaservis ", lat: 55.7172, lng: 21.1175, country: "Lithuania" }, // Klaipeda
    ...
    { rank: 651, name: "Omaha Mavericks", lat: 41.2565, lng: -95.9345, country: "USA" }, // Omaha
    ...
    { rank: 662, name: "The Citadel Bulldogs", lat: 32.7765, lng: -79.9311, country: "USA" }, // Charleston
    ...
    { rank: 666, name: "Norfolk State Spartans", lat: 36.8468, lng: -76.2852, country: "USA" }, // Norfolk
    ...
    { rank: 673, name: "Georgia State Panthers", lat: 33.7490, lng: -84.3880, country: "USA" }, // Atlanta
    { rank: 674, name: "Howard Bison", lat: 38.9072, lng: -77.0369, country: "USA" }, // Washington DC
    ...
    { rank: 685, name: "New Orleans Privateers", lat: 29.9511, lng: -90.0715, country: "USA" }, // New Orleans
    ...
    { rank: 689, name: "Long Island University Sharks", lat: 40.6892, lng: -73.9442, country: "USA" }, // Brooklyn
    { rank: 690, name: "Sacred Heart Pioneers", lat: 41.1579, lng: -73.2478, country: "USA" }, // Fairfield
    { rank: 691, name: "Central Connecticut Blue Devils", lat: 41.6488, lng: -72.7278, country: "USA" }, // New Britain
    { rank: 692, name: "St. Francis (BKN) Terriers", lat: 40.6892, lng: -73.9442, country: "USA" }, // Brooklyn
    ...
    { rank: 695, name: "Incarnate Word Cardinals", lat: 29.4241, lng: -98.4936, country: "USA" }, // San Antonio
    { rank: 696, name: "Mississippi Valley State Delta Devils", lat: 33.3515, lng: -90.3070, country: "USA" }, // Itta Bena
    { rank: 697, name: "Florida A&M Rattlers", lat: 30.4383, lng: -84.2807, country: "USA" }, // Tallahassee
    { rank: 698, name: "Southern Jaguars", lat: 29.9511, lng: -90.0715, country: "USA" }, // New Orleans
    ...
    { rank: 703, name: "Houston Baptist Huskies", lat: 29.7604, lng: -95.3698, country: "USA" }, // Houston
    ...
    { rank: 706, name: "Texas Southern Tigers", lat: 29.7604, lng: -95.3698, country: "USA" } // Houston
];